...
news = {
    ...
    fetchNews: function(country){
        fetch('https://newsapi.org/v2/top-headlines?country='+country+'&sortBy=popularity&apiKey=41170dee3c6a47ee89248457d24bf26a')
        .then((response)=>response.json())
...
/html/body/div[1]/div[1]/main/section/div/div/div[1]/div[2]/article[1]/div[2]/h3/a
